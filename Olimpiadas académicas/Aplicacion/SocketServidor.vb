...
#Region "METODOS"
    ...
    Public Sub Escuchar()
        ...
        'Dim ipO As New IPEndPoint("127.0.0.1", 7700)
        'tcpLsn = New TcpListener(ipO)
    ...
    Public Sub Cerrar(ByVal IDCliente As IPEndPoint)
    ...
    Public Sub EnviarDatos(ByVal IDCliente As IPEndPoint, ByVal Datos As String)
...
#Region "FUNCIONES PRIVADAS"
    ...
    Private Sub LeerSocket()
        Dim IDReal As IPEndPoint 'ID del cliente que se va a escuchar
                ...
                If .Socket.Connected Then
                    ...
                    Try
                        ...
                        If Ret > 0 Then
                            ...
                            .UltimosDatosRecibidos = Encoding.UTF8.GetString(Recibir)
