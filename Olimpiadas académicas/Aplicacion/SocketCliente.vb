...
#Region "VARIABLES"
    ...
    Public EstadoCon As Boolean = False
#End Region
...
#Region "METODOS"
    Public Sub Conectar()
        ...
        Catch ex As Exception
            'MsgBox("No se conectó con el equipo: " & IPDelHost)
            EstadoCon = False
        End Try
    ...
    Public Sub EnviarDatos(ByVal Datos As String)
        ...
        BufferDeEscritura = Encoding.UTF8.GetBytes(Datos)
    ...
    Private Sub LeerSocket()
        ...
        While True
            Try
                ...
                RaiseEvent DatosRecibidos(Encoding.UTF8.GetString(BufferDeLectura))
